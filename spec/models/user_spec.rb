...
RSpec.describe User, type: :model do
  ...
  it 'accepts a properly formatted email' do 
  	emails = ['crystal.stellwagen@emails.com', 'crystal@emails.com']
  ...
  it 'requires a unique, case-insensitive email address' do 
  	user1 = User.create(name:'Crystal', email:'crystal@emails.com', password:'password', password_confirmation:'password')
  ...
  it 'automatically encrypts the password into the password_digest attribute' do 
  	user = User.create(name: "Crystal", email: 'crystal@emails.com', password: 'password', password_confirmation: 'password')
